...
ascend_adapter_version="${ASCEND_ADAPTER_VERSION:-v0.1.0-rc.2}"
ascend_adapter_amd64_url="${ASCEND_ADAPTER_AMD64_URL:-https://github.com/openYuanrong-mirror/ascend-oci-adapter/releases/download/v0.1.0-rc.2/ascend-oci-adapter_v0.1.0-rc.2_linux_amd64.tar.gz}"
ascend_adapter_amd64_sha256="${ASCEND_ADAPTER_AMD64_SHA256:-abe3b926750c2467dc5544645bae530ec4bac8572615b0678892a4408d26954c}"
